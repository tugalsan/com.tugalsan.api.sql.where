...
public class TS_SQLWhereCondStrEqUpperCase extends TS_SQLWhereCondAbstract {
    ...
    public final static TS_Log d = TS_Log.of(TS_SQLWhereCondStrEqUpperCase.class.getSimpleName());
    ...
    public String toString() {
        ...
        return TGS_StringUtils.concat("UCASE(", columnName, ") = ?");
    }
    ...
    public int fill(PreparedStatement fillStmt, int offset) {
        try {
            ...
            throw new RuntimeException(TS_SQLWhereCondLngSmlOrEq.class.getSimpleName() + ".fll", ex);
        }
    }
}
