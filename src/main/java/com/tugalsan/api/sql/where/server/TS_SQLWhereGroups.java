...
public class TS_SQLWhereGroups {
    ...
    public TS_SQLWhereGroups groupsAnd(TGS_CallableType1_Run<TS_SQLWhereGroups> groups) {
    ...
    public TS_SQLWhereGroups groupsOr(TGS_CallableType1_Run<TS_SQLWhereGroups> groups) {
    ...
    public TS_SQLWhereConditions conditionsAnd(TGS_CallableType1_Run<TS_SQLWhereConditions> conditions) {
    ...
    public TS_SQLWhereConditions conditionsOr(TGS_CallableType1_Run<TS_SQLWhereConditions> conditions) {
